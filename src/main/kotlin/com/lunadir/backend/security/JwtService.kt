...
class JwtService(
    ...
    private fun generateToken(
        ...
        return Jwts.builder()
            ...
            .signWith(secretKey, Jwts.SIG.HS256) // A simple algorithm (HS256) is enough here, because the key is generated randomly
            .compact()
    }
    ...
    private fun validateToken(rawToken: String, expectedTokenType: TokenType): Boolean {
        ...
        val tokenType = claims["tokenType"] as? TokenType
            ?: return false
        return expectedTokenType == tokenType
    }
